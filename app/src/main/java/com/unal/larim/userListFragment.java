...
public class userListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<Participant>(
                getActivity(),
                R.layout.cardviewparticipant,
                R.id.textParticipantName,
                ParticipantsContent.ITEMS));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(ParticipantsContent.ITEMS.get(position).id);
    }
